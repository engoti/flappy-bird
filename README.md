...
In this tutorial, you will learn to create the Flappy Bird game with H.T.M.L, C.S.S, and Javascript. Specifically, you will learn how to code the game using html5 canvas. 
